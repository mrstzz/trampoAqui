...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="container mx-auto px-4 pb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-xl overflow-hidden transition-transform hover:shadow-2xl hover:-translate-y-1">
                
                <div class="h-48">
                    <img src="https://sintricomb.com.br/wp-content/uploads/2018/12/curso.jpg" alt="Imagem do Anúncio" class="w-full h-full object-cover" />
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div class="flex-shrink-0">
                            <img src="default-user.jpg" alt="Avatar do comerciante" class="w-12 h-12 rounded-full ring-2 ring-orange-600 ring-offset-2" />
                        </div>
                        <div>
                            <h2 class="text-lg font-bold text-gray-900"><?= htmlspecialchars($value['nome']); ?>, 22</h2>
                    ...
                    <div class="mb-4">
                        ...
                        <span class="ml-2 inline-block px-3 py-1 text-xs font-semibold text-orange-600 border border-orange-600 rounded-full">
                    ...
                    <div class="flex justify-end items-center mt-4 gap-2">
                        <button class="p-2 rounded-full text-gray-500 hover:bg-gray-100 hover:text-orange-600 transition-colors" aria-label="Favoritar">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
                        </button>
                        
                        <form action="#" method="post" class="inline">
                            <button type="submit" class="inline-block px-5 py-2 bg-orange-600 text-white font-semibold rounded-lg shadow-md hover:bg-orange-700 transition-colors">
                                Contratar
                            </button>
                        </form>
                    </div>
