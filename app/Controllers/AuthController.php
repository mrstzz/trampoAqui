...
use App\Models\Cliente; // Usará o model Cliente para autenticação
use App\Models\Comerciante; // Pode precisar para diferenciar login
use Core\Conexao;      // Para obter a conexão PDO
